...
## Exibimos os elementos de "x" entre as posicoes 5 e 8 (neste caso, os
## elementos 8, 9, 10 e 11)
x[5:8]

## Exibimos os elementos de "x" nas posicoes 11, 10 e 9, respectivamente (neste
## caso, os elementos 14, 13 e 12)
x[11:9]
